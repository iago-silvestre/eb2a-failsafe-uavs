...
public class MarsEnvStd extends Environment {
    ...
    public boolean executeAction(String ag, Structure action) {
        ...
        try {
            ...
            } else if (action.getFunctor().equals("critReac")) { 
    ...
    /* Current version only reacts to 'cr0' */
    void criticalAction(int j){
        switch (j) {
            case 0:
                //cpArray[0] = Boolean.FALSE; // reset respective perception
                reaction_times.add(System.nanoTime());
                break;
        
            default:
                break;
        }      
        //logger.info(" Executing criticalAction " + i);
    }
    ...
    // public boolean updateCBS() {
        ...
        // if((cpArray[0] == Boolean.FALSE) && (stepCtd >= 10) ) {
        //     stepCtd = 0;        // LB: next 10 lines commented because do not serve in Std Jason
        // if((cpArray[0] == Boolean.FALSE) && flagCvEv ) {
