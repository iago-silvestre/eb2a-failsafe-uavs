...
cp build.gradle.criticalJason.txt build.gradle
cp src/java/CriticalEmbeddedAgArch.jaBAA src/java/CriticalEmbeddedAgArch.java
...
rm src/java/CriticalEmbeddedAgArch.java
