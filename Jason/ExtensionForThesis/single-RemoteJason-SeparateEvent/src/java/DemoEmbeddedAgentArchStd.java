...
public class DemoEmbeddedAgentArchStd extends DefaultEmbeddedAgArch {
    ...
    public DemoEmbeddedAgentArchStd() {
        super();
    ...
    public Collection<Literal>perceive() {
        ...
        //System.out.println("cpIterationCounter: " +cpIterationCounter );
        /*if (this.cpIterationCounter >= this.nextCPTrigger ) {
            ...
            ReactionTime.markPerception();
            this.cpIterationCounter = 0;
            this.nextCPTrigger = 3 + new java.util.Random().nextInt(2);  // 100 + rand(200)
            this.cpCount++;
        }*/
        /*if (this.cpIterationCounter == null) {
            this.cpIterationCounter = 0;
