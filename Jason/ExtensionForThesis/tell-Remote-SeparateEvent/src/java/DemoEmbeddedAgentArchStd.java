...
public class DemoEmbeddedAgentArchStd extends DefaultEmbeddedAgArch {
    ...
    static {
        Map.of(
            5, List.of("cp3"),             //Catastrophic
            4, List.of("cp4" ),                   //Hazardous
            3, List.of("cp1"),                  //Major
            2, List.of("cp0"),            //Minor
    ...
    public Collection<Literal>perceive() {
        ...
        if (this.cpIterationCounter == null) {
            ...
            this.nextCPTrigger = 10 + new java.util.Random().nextInt(250);
            this.cpCount = 0;
        }
        ...
        for (Map.Entry<Integer, String> binding : cpBindings.entrySet()) {
            ...
            //bb.remove(ASSyntax.createLiteral("cp0[source(_)]"));
            Iterator<Literal> it = bb.getCandidateBeliefs(ASSyntax.createLiteral(functor), null);
